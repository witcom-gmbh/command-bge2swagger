...
@JsonSubTypes({@Type(value=MapTypeDto.class, name="map"),@Type(value=SimpleTypeDto.class, name="simple"), @Type(value=ListTypeDto.class, name="list"), @Type(value=ComplexTypeDto.class, name="complex"), @Type(value=TypeReferenceDto.class, name="reference")})
